...
export default class ScoreSchedule extends Component {
    componentWillMount () {
    ...
    return (
      ...
      <FlatList
          ...
          <View style={styles.halfClass}>
            ...
            <View style={styles.halfClassRight}>
              <Text style={styles.teachername}>{item.StuNum}</Text>
            </View>
          </View>
        </View>}
      />
...
AppRegistry.registerComponent('ScoreSchedule', () => ScoreSchedule);
