...
export default class Login extends Component {
  ...
  render() {
    ...
    return (
        ...
        />
        <TextInput style={styles.stu_input} placeholder="學號:" onChangeText={(account) => this.setState({account})} onSubmitEditing={Keyboard.dismiss}>
        </TextInput>
        <TextInput secureTextEntry={true} style={styles.pass_input} placeholder="密碼:" onChangeText={(password) => this.setState({password})} onSubmitEditing={Keyboard.dismiss}>
        </TextInput>
