      ...
      >
        <ScrollView>  
          ...
          <View style={styles.TextView}>
            ...
            <TextInput style={styles.name_input} placeholder="暱稱(顯示在抽卡上的" onChangeText={(nick_name) => this.setState({nick_name})}>
            </TextInput>
            <TextInput style={styles.major_input} placeholder="科系:" onChangeText={(major) => this.setState({major})}>
            </TextInput>
            <TextInput style={styles.gradenum_input} placeholder="年級:" onChangeText={(grade_num) => this.setState({grade_num})}>
            </TextInput>
